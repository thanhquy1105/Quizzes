...
- **Giao thức Binary**: Sử dụng khung truyền tin (framing) `BTASKEE` tùy chỉnh trên WebSockets để giao tiếp hiệu quả, tối ưu băng thông. Xem [Tài liệu Protocol](internal/server/proto/README_VN.md).
