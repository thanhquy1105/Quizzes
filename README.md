...
This project demonstrates a real-time quiz feature using a Go-based server (`server`) and a ReactJS frontend connected via WebSockets using a custom binary protocol.
